...
namespace AdventOfCode {
    public class Day4 {
        public static void Start()
        {
            ...
            Console.WriteLine("Horizontal: " + total);
            total += VerticalCalculator(input);
            Console.WriteLine("Horizontal + vertical: " + total);
            total += DiagonalCalculatorLeftToRight(input);
            Console.WriteLine(total);
            total += DiagonalCalculatorRightToLeft(input);
            Console.WriteLine(total);

            //guess 1: 2581
        }

        public static int DiagonalCalculatorLeftToRight(string input) { 
            var total = 0;
        ...
        public static int DiagonalCalculatorRightToLeft(string input)
        {
            var total = 0;
            var lines = input.Split("\r\n");
            var lineLength = lines[0].Length;
